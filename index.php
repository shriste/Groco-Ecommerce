			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">worth the money</h4>
						</div>
					</div>	
					<h6 class="text">Freshness</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#books" data-toggle="tab">Fruits</a></li>
					<li><a href="#furniture" data-toggle="tab">Vegetables</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Seed and Fertilizer</h3>
